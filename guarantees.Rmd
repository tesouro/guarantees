---
title: "GUARANTEES PANEL"
runtime: shiny
output: 
  flexdashboard::flex_dashboard:
    navbar:
      - { title: "Position: 04/30/2020",icon: ion-ios-calendar-outline, href: "https://www.gov.br/tesouronacional/en/federal-public-debt" ,align: right }
    orientation: columns
...
agrupador_ATM_geral_formatado <- agrupador_ATM_geral_formatado %>%
  mutate(Inicio_ingles = Inicio)

agrupador_ATM_geral_formatado[2,11] <- "States"
agrupador_ATM_geral_formatado[3,11] <- "Municipalities"
agrupador_ATM_geral_formatado[4,11] <- "Federal Banks"
agrupador_ATM_geral_formatado[5,11] <- "Controlled Entities"
agrupador_ATM_geral_formatado[6,11] <- "Federal SOE"
...
agrupador_custo_geral_formatado <- agrupador_custo_geral_formatado %>%
  mutate(Inicio_ingles = Inicio)

agrupador_custo_geral_formatado[2,12] <- "States"
agrupador_custo_geral_formatado[3,12] <- "Municipalities"
agrupador_custo_geral_formatado[4,12] <- "Federal Banks"
agrupador_custo_geral_formatado[5,12] <- "Controlled Entities"
agrupador_custo_geral_formatado[6,12] <- "Federal SOE"
...
agrupador_percentual_vincendo_geral_formatado <- agrupador_percentual_vincendo_geral_formatado %>%
  mutate(Inicio_ingles = Inicio)

agrupador_percentual_vincendo_geral_formatado[2,19] <- "States"
agrupador_percentual_vincendo_geral_formatado[3,19] <- "Municipalities"
agrupador_percentual_vincendo_geral_formatado[4,19] <- "Federal Banks"
agrupador_percentual_vincendo_geral_formatado[5,19] <- "Controlled Entities"
agrupador_percentual_vincendo_geral_formatado[6,19] <- "Federal SOE"
                 
agrupador_formatado_geral <- agrupador_formatado_geral %>%
  mutate(Inicio_ingles = Inicio)

agrupador_formatado_geral[2,43] <- "States"
agrupador_formatado_geral[3,43] <- "Municipalities"
agrupador_formatado_geral[4,43] <- "Federal Banks"
agrupador_formatado_geral[5,43] <- "Controlled Entities"
agrupador_formatado_geral[6,43] <- "Federal SOE"
...
mutuarios_geral_ingles <- c("Total","States","Municipalities","Federal Banks","Federal SOE","Controlled Entities")
...
fluidRow(
  column(5,div(selectInput("Geral", 
                 ...
                 choices = (mutuarios_geral_ingles)), id="geral"))
  ...
  observeEvent(botoes_geral(),{
    ...
    if (is.null(input$Geral)){entrada <- agrupador_formatado_geral$Inicio_ingles[1]} 
    else
    {entrada <- input$Geral}
...
fluidPage(
 fluidRow(
  ...
  column(width=6,align="center",div(style = "height:17px;font-size: 12pt;background-color: ;","")),
   ...
   column(width=3,align="right",div(style = "height:17px;font-size: 12pt;background-color: ;","R$ Million")),
   br(),
  column(width=6,align="left",div(style = "height:17px;font-size: 13pt;font-weight: bold;background-color: ;","TOTAL GUARANTEED DEBT")),
  ...
  column(width=6,align="left",div(style = "height:17px;font-size: 13pt;background-color: ;","DOMESTIC")),
  ...
  column(width=6,align="center",div(style = "height:17px;color: #737373;background-color: ;","FX-Linked:")),
  ...
  column(width=5,align="center",div(style = "height:17px;color: #737373;background-color: ;"," Other:")),
 ...
 br(), 
  column(width=6,align="left",div(style = "height:17px;font-size: 13pt;background-color: ;","EXTERNAL")),
  
  column(width=3,align="right",div(style = "height:17px;font-size: 13pt;background-color: ;",textOutput("Garantia_externa_geral"))),
  
      br(), br(),
  column(width=5,align="left",div(style = "height:17px;font-size: 13pt;font-weight: bold;background-color: ;","ATM")),
  column(width=4,align="right",div(style = "height:17px;font-size: 13pt;font-weight: bold;background-color: ;",textOutput("Garantia_ATM_geral"))),
      br(),br(),
  column(width=5,align="left",div(style = "height:17px;font-size: 13pt;font-weight: bold;background-color: ;","AVERAGE COST")),
  column(width=4,align="right",div(style = "height:17px;font-size: 13pt;font-weight: bold;background-color: ;",textOutput("Garantia_custo_geral"))),
      br(),br(),
  column(width=6,align="left",div(style = "height:17px;font-size: 13pt;font-weight: bold;background-color: ;","Maturity Profile")),
  column(width=2,align="center",div(style = "height:17px;font-size: 12pt;background-color: ;","")),
      
  column(width=4,align="right",div(style = "height:17px;font-size: 12pt;background-color: ;","R$ Million")),
  br(),
  
  column(width=3,align="left",div(style = "height:17px;background-color: ;","12 months")),
  ...
  br(),
  column(width=3,align="left",div(style = "height:17px;background-color: ;","1 to 2 yrs")),
  ...
  br(),
  column(width=3,align="left",div(style = "height:17px;background-color: ;","2 to 3 yrs")),
  ...
  br(),
  column(width=3,align="left",div(style = "height:17px;background-color: ;","3 to 4 yrs")),
  ...
  column(width=3,align="left",div(style = "height:17px;background-color: ;","4 to 5 yrs")),
  ...
  br(),
  column(width=3,align="left",div(style = "height:17px;background-color: ;","More 5 yrs")),
...
observeEvent(Garantia_ATM_reativo_geral(),{
  ...
  output$Garantia_ATM_geral <- renderText(paste0(str_replace_all(round(filtro_classificador_geral_atm$ATM_Total,2),"\\.",","), " years"))
  ...
  output$Garantia_custo_geral <- renderText(paste0(filtro_classificador_geral_custo$Custo_Total, " p.a"))
...
Total <- barras %>%
        filter(Inicio_ingles == "Total")

Estados <- barras %>%
          filter(Inicio_ingles == "States")
...
Municipios <- barras %>%
          filter(Inicio_ingles == "Municipalities")
...
Bancos_Federais <- barras %>%
          filter(Inicio_ingles == "Federal Banks")
...
Estatais_Federais <- barras %>%
          filter(Inicio_ingles == "Federal SOE")
...
Entidades_Controladas <- barras %>%
          filter(Inicio_ingles == "Controlled Entities")
...
cores_gera_total_estados<-reactive({ifelse("Total"== cor_reativo_geral_total() |"States"==cor_reativo_geral_total(),"rgb(61, 145, 194)","rgb(191, 191, 191)")})

cores_gera_total_municipios<-reactive({ifelse("Total"== cor_reativo_geral_total() |"Municipalities"==cor_reativo_geral_total(),"rgb(100, 167, 206)","rgb(191, 191, 191)")})

cores_gera_total_bancos_federais<-reactive({ifelse("Total"== cor_reativo_geral_total() |"Federal Banks"==cor_reativo_geral_total(),"rgb(139, 189, 218)","rgb(191, 191, 191)")})

cores_gera_total_estatais_federais<-reactive({ifelse("Total"== cor_reativo_geral_total() |"Federal SOE"==cor_reativo_geral_total(),"rgb(177, 211, 231)","rgb(191, 191, 191)")})

cores_gera_total_entidades_controladas<-reactive({ifelse("Total"== cor_reativo_geral_total() |"Controlled Entities"==cor_reativo_geral_total(),"rgb(216, 233, 243)","rgb(191, 191, 191)")})
...
fluidRow(
  ...
  column(11,div(style = "font-size: 11pt; font-family: monospace;","Domestic Guarantees"),div(style = "font-size: 10pt;",textOutput("nominal_garantia_interna")) ,plotlyOutput("barras_total_interna")),
  
  br(),br(),br(), br(),br(), br(),br(), br(),br(), br(),br(), br(),
  
  column(11,div(style = "font-size: 11pt; font-family: monospace;","External Guarantees"),div(style = "font-size: 10pt;",textOutput("nominal_garantia_externa")),plotlyOutput("barras_total_externa"))
 ...
 plot_ly(barras,y=~y_geral, type = 'bar', 
      ...
      x = ~Estados_valor,name = "States",
          showlegend= ifelse(Estados_valor==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_estados(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
       text = ~paste0("<b>Type of Entity:</b> ","States","<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estados_valor)," Million","<br><b>Total Portion:</b> ",funcao_percentual_taxa(Estados_valor/barras$total_total[1])),              
  ...
  hoverinfo = "text"
     ...
     add_trace(x = ~Municipios_valor,name ="Municipalities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Municipality","<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Municipios_valor)," Million","<br><b>Total Portion:</b> ",funcao_percentual_taxa(Municipios_valor/barras$total_total[1])),              
  
  hoverinfo = "text"
                      ) %>%
  
  
  add_trace(x = ~Bancos_Federais_valor,name ="Federal Banks",
                 showlegend= ifelse(Bancos_Federais_valor==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_bancos_federais(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
                       text = ~paste0("<b>Type of Entity:</b> ","Federal Banks","<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Bancos_Federais_valor)," Million","<br><b>Total Portion:</b> ",funcao_percentual_taxa(Bancos_Federais_valor/barras$total_total[1])),              
  ...
  add_trace(x = ~Estatais_Federais_valor,name ="Federal SOE",
                 showlegend= ifelse(Estatais_Federais_valor==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_estatais_federais(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
        text = ~paste0("<b>Type of Entity:</b> ","Federal SOE","<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estatais_Federais_valor)," Million","<br><b>Total Portion:</b> ",funcao_percentual_taxa(Estatais_Federais_valor/barras$total_total[1])),              
  
  hoverinfo = "text"
        
                      ) %>%
  
  add_trace(x = ~Entidades_Controladas_valor,name ="Controlled Entities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Controlled Entities","<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Entidades_Controladas_valor)," Million","<br><b>Total Portion:</b> ",funcao_percentual_taxa(Entidades_Controladas_valor/barras$total_total[1])),              
...
output$barras_total_interna <- renderPlotly({
 ...
 plot_ly( type = 'bar', 
      ...
      x = ~Estados_valor_interna,name = "States",
                 showlegend= ifelse(Estados_valor_interna==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_estados(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
       text = ~paste0("<b>Type of Entity:</b> ","States","<br><b>Domestic Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estados_valor_interna)," Million"),              
  ...
  hoverinfo = "text"
    ...
    add_trace(x = ~Municipios_valor_interna,name ="Municipalities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Municipalities","<br><b>Domestic Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Municipios_valor_interna)," Million"),              
  
  hoverinfo = "text"
                      ) %>%
  
  
  add_trace(x = ~Bancos_Federais_valor_interna,name ="Federal Banks",
                 showlegend= ifelse(Bancos_Federais_valor_interna==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_bancos_federais(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
                       text = ~paste0("<b>Type of Entity:</b> ","Federal Banks","<br><b>Domestic Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Bancos_Federais_valor_interna)," Million"),              
  ...
  add_trace(x = ~Estatais_Federais_valor_interna,name ="Federal SOE",
                 showlegend= ifelse(Estatais_Federais_valor_interna==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_estatais_federais(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
        text = ~paste0("<b>Type of Entity:</b> ","Federal SOE","<br><b>Domestic Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estatais_Federais_valor_interna)," Million"),              
  
  hoverinfo = "text"
        
                      ) %>%
  
  add_trace(x = ~Entidades_Controladas_valor_interna,name ="Controlled Entities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Controlled Entities","<br><b>Domestic Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Entidades_Controladas_valor_interna)," Million"),              
...
output$barras_total_externa <- renderPlotly({
 ...
 plot_ly( type = 'bar', 
      ...
      x = ~Estados_valor_externa,name = "States",
                 showlegend= ifelse(Estados_valor_externa==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_estados(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
       text = ~paste0("<b>Type of Entity:</b> ","States","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estados_valor_externa)," Million"),              
  ...
  hoverinfo = "text"
    ...
    add_trace(x = ~Municipios_valor_externa,name ="Municipalities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Municipalities","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Municipios_valor_externa)," Million"),              
  
  hoverinfo = "text"
                      ) %>%
  
  
  add_trace(x = ~Bancos_Federais_valor_externa,name ="Federal Banks",
                 showlegend= ifelse(Bancos_Federais_valor_externa==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_bancos_federais(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
                       text = ~paste0("<b>Type of Entity:</b> ","Federal Banks","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Bancos_Federais_valor_externa)," Million"),              
  ...
  add_trace(x = ~Estatais_Federais_valor_externa,name ="Federal SOE",
                 showlegend= ifelse(Estatais_Federais_valor_externa==0,FALSE,TRUE), 
      
        marker = list(color = cores_gera_total_estatais_federais(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
        text = ~paste0("<b>Type of Entity:</b> ","Federal SOE","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estatais_Federais_valor_externa)," Million"),              
  
  hoverinfo = "text"
        
                      ) %>%
  
  add_trace(x = ~Entidades_Controladas_valor_externa,name ="Controlled Entities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Controlled Entities","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Entidades_Controladas_valor_externa)," Million"),              
...
output$nominal_garantia <- renderText(paste0("R$ ",funcao_formata_quantidade(nominal_percentual_operacoes_total$total_total)," Million"," (",funcao_percentual_taxa(nominal_percentual_operacoes_total$total_total/ nominal_percentual_operacoes_total$total_total),")"))

output$nominal_garantia_interna <- renderText(paste0("R$ ",funcao_formata_quantidade(nominal_percentual_operacoes_total$interna_total)," Million"," (",funcao_percentual_taxa(nominal_percentual_operacoes_total$interna_total/ nominal_percentual_operacoes_total$total_total),")"))

output$nominal_garantia_externa <- renderText(paste0("R$ ",funcao_formata_quantidade(nominal_percentual_operacoes_total$externa_total)," Million"," (",funcao_percentual_taxa(nominal_percentual_operacoes_total$externa_total/ nominal_percentual_operacoes_total$total_total),")"))
...
fluidRow(
  ...
  column(11,div(style = "font-size: 11pt;font-weight: bold; font-family: monospace;","TOTAL ATM"),div(style = "font-size: 10pt;font-weight: bold;",textOutput("atm_total_percentual")), plotlyOutput("barras_total_atm")),
  

  
  
  column(11,div(style = "font-size: 11pt;font-family: monospace;","DOMESTIC ATM"),div(style = "font-size: 10pt;",textOutput("atm_interna_percentual")) ,plotlyOutput("barras_total_atm_interna")),
  
  
  
  column(11,div(style = "font-size: 11pt; font-family: monospace;","EXTERNAL ATM"),div(style = "font-size: 10pt;",textOutput("atm_externa_percentual")),plotlyOutput("barras_total_atm_externa"))
  
))


y_atm <- c("States", "Federal Banks", "Municipalities", "Federal SOE", "Controlled Entities")
...
#tem gambiarra aqui nesse ponto - retiramos Entidades controladas para nao aparecer NA

y_atm_interna <- c("States", "Federal Banks", "Municipalities", "Federal SOE")
...
#tem gambiarra aqui nesse ponto
...
output$atm_total_percentual <- renderText(paste0(round(Total_valor_atm,2)," years"))
output$atm_interna_percentual <- renderText(paste0(round(Total_valor_atm_interna,2)," years"))
output$atm_externa_percentual <- renderText(paste0(round(Total_valor_atm_externa,2)," years"))
...
cores_geral_custo<-reactive({if("Total"== cor_reativo_geral_custo())
                           {"rgb(103, 169, 207)"}
                         else if("States"==cor_reativo_geral_custo())
                         {c("rgb(103, 169, 207)","rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(191, 191, 191)")}
                         else if("Federal Banks"==cor_reativo_geral_custo())
                         {c("rgb(191, 191, 191)","rgb(103, 169, 207)","rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(191, 191, 191)")}                  
                         else if("Municipalities"==cor_reativo_geral_custo())
                         {c("rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(103, 169, 207)","rgb(191, 191, 191)","rgb(191, 191, 191)")} 
                         else if("Federal SOE"==cor_reativo_geral_custo())
                         {c("rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(103, 169, 207)","rgb(191, 191, 191)")}
                         else if("Controlled Entities"==cor_reativo_geral_custo())
                         {c("rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(191, 191, 191)","rgb(103, 169, 207)")}
...
fluidRow(
  ...
  column(11,div(style = "font-size: 11pt;font-weight: bold; font-family: monospace;","TOTAL AVERAGE COST"),div(style = "font-size: 10pt;font-weight: bold;",textOutput("custo_total_percentual")), plotlyOutput("barras_total_custo")),
  

  
  
  column(11,div(style = "font-size: 11pt; font-family: monospace;","DOMESTIC AVERAGE COST"),div(style = "font-size: 10pt;",textOutput("custo_interna_percentual")) ,plotlyOutput("barras_total_custo_interna")),
  
  
  
  column(11,div(style = "font-size: 11pt; font-family: monospace;","EXTERNAL AVERAGE COST"),div(style = "font-size: 10pt;",textOutput("custo_externa_percentual")),plotlyOutput("barras_total_custo_externa"))
  
))


y_custo <- c("States", "Federal Banks", "Municipalities", "Federal SOE", "Controlled Entities")
...
output$barras_total_custo <- renderPlotly({
  ...
  layout(height = 190, 
         ...
         xaxis = list(title = "",
                      range = c(0,max(barras_custo$Custo_Total_formatado,barras_custo$Custo_Interno_formatado,barras_custo$Custo_Externo_formatado, na.rm = TRUE)),
...
#Tem gambiarra nesse ponto - Retirar Entidades Controladas para nao aparecer NA's

y_custo_interna <- c("States", "Federal Banks", "Municipalities", "Federal SOE")
...
output$custo_total_percentual <- renderText(paste0(Total_valor_custo," % per annum"))
output$custo_interna_percentual <- renderText(paste0(Total_valor_custo_interna," % per annum"))
output$custo_externa_percentual <- renderText(paste0(Total_valor_custo_externa," % per annum"))
...
cores_gera_total_estados_cambial<-reactive({ifelse("Total"== cor_reativo_geral_total_cambial() |"States"==cor_reativo_geral_total_cambial(),"rgb(61, 145, 194)","rgb(191, 191, 191)")})

cores_gera_total_municipios_cambial<-reactive({ifelse("Total"== cor_reativo_geral_total_cambial() |"Municipalities"==cor_reativo_geral_total_cambial(),"rgb(100, 167, 206)","rgb(191, 191, 191)")})

cores_gera_total_bancos_federais_cambial<-reactive({ifelse("Total"== cor_reativo_geral_total_cambial() |"Federal Banks"==cor_reativo_geral_total_cambial(),"rgb(139, 189, 218)","rgb(191, 191, 191)")})

cores_gera_total_estatais_federais_cambial<-reactive({ifelse("Total"== cor_reativo_geral_total_cambial() |"Federal SOE"==cor_reativo_geral_total_cambial(),"rgb(177, 211, 231)","rgb(191, 191, 191)")})

cores_gera_total_entidades_controladas_cambial<-reactive({ifelse("Total"== cor_reativo_geral_total_cambial() |"Controlled Entities"==cor_reativo_geral_total_cambial(),"rgb(216, 233, 243)","rgb(191, 191, 191)")})
...
fluidRow(
  ...
  column(11,div(style = "font-size: 11pt; font-family: monospace;","DOMESTIC FX-LINKED"),div(style = "font-size: 10pt;",textOutput("nominal_garantia_interna_cambiais")) ,plotlyOutput("barras_total_interna_cambial")),
  
  br(),br(),br(), br(),br(), br(),br(), br(),br(), br(),br(), 
  
  column(11,div(style = "font-size: 11pt; font-family: monospace;","EXTERNAL"),div(style = "font-size: 10pt;",textOutput("nominal_garantia_externa_cambiais")),plotlyOutput("barras_total_externa_cambial"))
 ...
 p <- plot_ly(barras_cambial, type = 'bar', traceorder ="reversed") %>%
     ...
     add_trace( x = ~Estados_valor_cambial,name = "States",
                 showlegend= ifelse(Estados_valor_cambial==0,FALSE,TRUE),
            
        marker = list(color = cores_gera_total_estados_cambial(),
                      line = list(color ="rgb(242, 242, 242)",
                                  width = 3)),
       text = ~paste0("<b>Type of Entity:</b> ","States","<br><b>FX-Lienked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estados_valor_cambial)," Million","<br><b>Portion FX-Linked:</b> ",funcao_percentual_taxa(Estados_valor_cambial/Estados_valor)),              
  ...
  hoverinfo = "text"
     ...
     add_trace(x = ~Municipios_valor_cambial,name ="Municipalities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Municipalities","<br><b>FX-Lienked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Municipios_valor_cambial)," Million","<br><b>Portion FX-Linked:</b> ",funcao_percentual_taxa(Municipios_valor_cambial/Municipios_valor)),              
  
  hoverinfo = "text"
                      ) %>%
     
     add_trace(x = ~Bancos_Federais_valor_cambial,name ="Federal Banks",
                showlegend= ifelse(Bancos_Federais_valor_cambial==0,FALSE,TRUE),
               
        marker = list(color = cores_gera_total_bancos_federais_cambial(),
                      line = list(color ="rgb(242, 242, 242)",
                                  width = 3)),
                       text = ~paste0("<b>Type of Entity:</b> ","Federal Banks","<br><b>FX-Lienked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Bancos_Federais_valor_cambial)," Milhões","<br><b>Portion FX-Linked:</b> ",funcao_percentual_taxa(Bancos_Federais_valor_cambial/Bancos_Federais_valor)),              
  ...
  add_trace(x = ~Estatais_Federais_valor_cambial,name ="Federal SOE",
        ...
        marker = list(color = cores_gera_total_estatais_federais_cambial(),
                      line = list(color ="rgb(242, 242, 242)",
                                  width = 3)),
        text = ~paste0("<b>Type of Entity:</b> ","Federal SOE","<br><b>FX-Lienked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estatais_Federais_valor_cambial)," Million","<br><b>Portion FX-Linked:</b> ",funcao_percentual_taxa(Estatais_Federais_valor_cambial/Estatais_Federais_valor)),              
  ...
  add_trace(x = ~Entidades_Controladas_valor_cambial,name ="Controlled Entities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Controlled Entities","<br><b>FX-Lienked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Entidades_Controladas_valor_cambial)," Million","<br><b>Portion FX-Linked:</b> ",funcao_percentual_taxa(Entidades_Controladas_valor_cambial/Entidades_Controladas_valor)),              
  ...
  hoverinfo = "text"
     ...
     add_trace(x = ~(Total_cambial$total_total-Total_cambial$total_cambial),name ="No FX-Linked",
                 showlegend=FALSE,
        ...
        text = ~paste0("<b>No FX-Linked Guaranteed Debt</b> ","<br><b>Total:</b> ","R$",funcao_formata_quantidade_2(Total_cambial$total_total-Total_cambial$total_cambial)," Milion","<br><b>Portion of Total:</b> ",funcao_percentual_taxa((Total_cambial$total_total-Total_cambial$total_cambial)/Total_cambial$total_total)),              
...
output$barras_total_interna_cambial <- renderPlotly({
 ...
 plot_ly(type = 'bar',orientation = 'h', 
      ...
      x = ~Estados_valor_interna_cambial,name = "States",
      showlegend= ifelse(Estados_valor_interna_cambial==0,FALSE,TRUE),
                 
        marker = list(color = cores_gera_total_estados_cambial(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
       text = ~paste0("<b>Type of Entity:</b> ","States","<br><b>Domestic FX-Linked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estados_valor_interna_cambial)," Million"),              
  ...
  hoverinfo = "text"
    ...
    add_trace(x = ~Municipios_valor_interna_cambial,name ="Municipalities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Municipalities","<br><b>Domestic FX-Linked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Municipios_valor_interna_cambial)," Million"),              
  
  hoverinfo = "text"
                      ) %>%
  
  add_trace(x = ~Bancos_Federais_valor_interna_cambial,name ="Federal Banks",
            showlegend= ifelse(Bancos_Federais_valor_interna_cambial==0,FALSE,TRUE),
                 
        marker = list(color = cores_gera_total_bancos_federais_cambial(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
                       text = ~paste0("<b>Type of Entity:</b> ","Federal Banks","<br><b>Domestic FX-Linked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Bancos_Federais_valor_interna_cambial)," Million"),              
  ...
  add_trace(x = ~Estatais_Federais_valor_interna_cambial,name ="Federal SOE",
        ...
        marker = list(color = cores_gera_total_estatais_federais_cambial(),
                      ...
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
        text = ~paste0("<b>Type of Entity:</b> ","Federal SOE","<br><b>Domestic FX-Linked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estatais_Federais_valor_interna_cambial)," Million"),              
  
  hoverinfo = "text"
        
                      ) %>%
  
  add_trace(x = ~Entidades_Controladas_valor_interna_cambial,name ="Controlled Entities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Controlled Entities","<br><b>Domestic FX-Linked Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Entidades_Controladas_valor_interna_cambial)," Million"),              
...
output$barras_total_externa_cambial <- renderPlotly({
 ...
 plot_ly( type = 'bar') %>%
     ...
     add_trace( x = ~Estados_valor_externa_cambial,name = "States",
                 showlegend= ifelse(Estados_valor_externa_cambial==0,FALSE,TRUE),
               
        marker = list(color = cores_gera_total_estados_cambial(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
       text = ~paste0("<b>Type of Entity:</b> ","States","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estados_valor_externa_cambial)," Million"),              
  ...
  hoverinfo = "text"
    ...
    add_trace(x = ~Municipios_valor_externa_cambial,name ="Municipalities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Municipalities","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Municipios_valor_externa_cambial)," Million"),              
  
  hoverinfo = "text"
                      ) %>%
  
  add_trace(x = ~Bancos_Federais_valor_externa_cambial,name ="Federal Banks",
                 showlegend= ifelse(Bancos_Federais_valor_externa_cambial==0,FALSE,TRUE),
                
        marker = list(color = cores_gera_total_bancos_federais_cambial(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
                       text = ~paste0("<b>Type of Entity:</b> ","Federal Banks","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Bancos_Federais_valor_externa_cambial)," Million"),              
  ...
  add_trace(x = ~Estatais_Federais_valor_externa_cambial,name ="Federal SOE",
               showlegend= ifelse(Estatais_Federais_valor_externa_cambial==0,FALSE,TRUE),
                  
        marker = list(color = cores_gera_total_estatais_federais_cambial(),
                      line = list(color = "rgb(242, 242, 242)",
                                  width = 3)),
        text = ~paste0("<b>Type of Entity:</b> ","Federal SOE","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Estatais_Federais_valor_externa_cambial)," Million"),              
  
  hoverinfo = "text"
        
                      ) %>%
  
  add_trace(x = ~Entidades_Controladas_valor_externa_cambial,name ="Controlled Entities",
        ...
        text = ~paste0("<b>Type of Entity:</b> ","Controlled Entities","<br><b>External Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(Entidades_Controladas_valor_externa_cambial)," Million"),              
...
output$nominal_garantia_cambiais <- renderText(paste0("R$ ",funcao_formata_quantidade(nominal_percentual_operacoes_total_cambiais$interna_USD+nominal_percentual_operacoes_total_cambiais$externa_total)," Million"," (",funcao_percentual_taxa((nominal_percentual_operacoes_total_cambiais$interna_USD+nominal_percentual_operacoes_total_cambiais$externa_total)/ nominal_percentual_operacoes_total_cambiais$total_total),")"))

output$nominal_garantia_interna_cambiais <- renderText(paste0("R$ ",funcao_formata_quantidade(nominal_percentual_operacoes_total_cambiais$interna_USD)," Million"," (",funcao_percentual_taxa(nominal_percentual_operacoes_total_cambiais$interna_USD/ (nominal_percentual_operacoes_total_cambiais$interna_USD+nominal_percentual_operacoes_total_cambiais$externa_total)),")"))

output$nominal_garantia_externa_cambiais <- renderText(paste0("R$ ",funcao_formata_quantidade(nominal_percentual_operacoes_total_cambiais$externa_total)," Million"," (",funcao_percentual_taxa(nominal_percentual_operacoes_total_cambiais$externa_total/ (nominal_percentual_operacoes_total_cambiais$interna_USD+nominal_percentual_operacoes_total_cambiais$externa_total)),")"))
...
Quadro_geral_operacoes_garantidas_nome <- reactive({
 ...
 observeEvent(Quadro_geral_operacoes_garantidas_nome(),{
   ...
   if(entrada == "States"){
         ...
         total_texto <- "of States" 
                }
   if(entrada == "Municipalities"){

         total_texto <- "of Municipalities" 
                }
   if(entrada == "Federal Banks"){

         total_texto <- "of Federal Banks" 
                }
   if(entrada == "Federal SOE"){

         total_texto <- "of Federal SOE" 
                }
   if(entrada == "Controlled Entities"){

         total_texto <- "of Controlled Entities" 
                }
   
  
output$texto_garantia_cambiais <- renderText(paste0("Total FX-Linked (Domestic FX-Linked + External) participation in Guaranteed Debt " ,total_texto))
...
fluidPage(
 fluidRow(
   ...
   column(width=7,align="left",div(style = "height:40px;font-size: 13pt;font-weight: bold;background-color: ;","INTERNAL CREDIT RATING (CAPAG)")),
...
observeEvent(Garantia_ATM_reativo(),{
  ...
  output$Garantia_ATM <- renderText(paste0(str_replace_all(round(filtro_classificador_estado_atm$ATM_Total,2),"\\.",","), " years"))
  ...
  output$Garantia_custo <- renderText(paste0(filtro_classificador_estado_custo$Custo_Total, " p.a"))
...
output$divida_total_estados <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_estados, x=~Inicio) %>%
       add_trace(y = ~total_total/1000000,
                 ...
                 text = ~paste0("<b>States:</b> ", Inicio,"<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(total_total)," Milhões","<br><b>Portion States:</b> ",funcao_percentual_taxa(total_total/sum(total_total)) ,"<br><b>Portion Total:</b> ",funcao_percentual_taxa(total_total/sum(agrupador_total_formatado$total_total)),"<br><b>Position States:</b> ",order(total_total, decreasing = TRUE),"° Place" ),   
  ...
  hoverinfo = "text"
      ...
      layout(showlegend=TRUE, 
             ...
             yaxis = list(side = 'left' ,title = '<b>Guaranteed Debt - R$ Million</b> ', showline = FALSE ,showgrid = FALSE, zeroline = FALSE,tickformat = ',.2r',
...
> **Source:**  [Brazilian National Treasury Secretary](https://www.gov.br/tesouronacional/en/federal-public-debt)
<br>**Note:** All 26 States plus the Federal District have debt guaranteed by the Federal Government. 
...
output$ATM <-renderPlotly(
  ...
  plot_ly(agrupador_ATM_estados_formatado, x=~Inicio) %>%
       ...
       add_trace(y = ~ATM_Total,
                 ...
                 text = ~paste0("<b>States:</b> ", Inicio,"<br><b>ATM:</b> ",round(ATM_Total,2)," years"),
                hoverinfo = "text"
  ...
  add_trace(y = ~sum((agrupador_ATM_estados_formatado$ATM_Total*agrupador_formatado_estados$total_total))/sum(agrupador_formatado_estados$total_total),
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_ATM_estados_formatado$ATM_Total*agrupador_formatado_estados$total_total))/sum(agrupador_formatado_estados$total_total),2)," years"),
      ...
      layout(showlegend=TRUE, 
             ...
             yaxis = list(side = 'left',showlegend = FALSE,showgrid = FALSE ,title = '<b>ATM (years)</b> ', showline = FALSE , zeroline = FALSE,hoverformat = '.2f',
                          rangemode = "tozero"
                          )) %>%
...
output$custos_estados <-renderPlotly(
  ...
  plot_ly(agrupador_custo_estados_formatado, x=~Inicio) %>%
    ...
    add_trace(y = ~sum((agrupador_custo_estados_formatado$Custo_total_formatado*agrupador_formatado_estados$total_total))/sum(agrupador_formatado_estados$total_total) ,
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_custo_estados_formatado$Custo_total_formatado*agrupador_formatado_estados$total_total))/sum(agrupador_formatado_estados$total_total),2),"% p.a" ),
      ...
      hoverinfo = "text") %>%
       ...
       add_trace(y = ~Custo_total_formatado,
                 ...
                 text = ~paste0("<b>States:</b> ", Inicio,"<br><b>Cost:</b> ",round(Custo_total_formatado,2),"% p.a"),              
  ...
  hoverinfo = "text"
      ...
      layout(showlegend=TRUE, 
             ...
             yaxis = list(side = 'left',showlegend = FALSE ,title = '<b>Average Cost - % p.a</b> ', showline = FALSE ,showgrid = FALSE, zeroline = FALSE,hoverformat = '.2f',
                          rangemode = "tozero"
                          )) %>%
...
output$cambial_estados <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_estados, x=~Inicio) %>%
       ...
       add_trace(y = ~100*((total_cambial)/(total_total)),
                 ...
                 text = ~paste0("<b>States:</b> ", Inicio,"<br><b>Fx-Linked:</b> ",round(100*(total_cambial/total_total),2),"%"),              
  ...
  hoverinfo = "text"
      ...
      layout( legend = list(orientation = 'h', x = 0.8, y = 1.2,
             ...
             yaxis = list(side = 'left',showlegend = FALSE ,title = '<b>Fx-Linked - part. Guaranteed Debt (%)</b> ', showline = FALSE ,showgrid = FALSE, zeroline = FALSE,hoverformat = '.2f',
...
> **Source:**  [Brazilian National Treasury Secretary](https://www.gov.br/tesouronacional/en/federal-public-debt)
  <br>**Note:**Total FX-Linked Debt is the sum of Domestic FX-Linked Debt and External Debt. The participation of Total FX-Linked Debt in the portfolio is calculated by dividing the foreign exchange portion by the total debt..
...
observeEvent(Garantia_ATM_reativo_municipios(),{
  ...
  output$Garantia_ATM_municipios <- renderText(paste0(str_replace_all(round(filtro_classificador_estado_atm_municipios$ATM_Total,2),"\\.",","), " years"))
  ...
  output$Garantia_custo_municipios <- renderText(paste0(filtro_classificador_custo_municipios$Custo_Total, " p.a"))
...
output$divida_total_municipios <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_municipios, x=~Inicio) %>%
       ...
       add_trace(y = ~(total_total/1000000),
                 ...
                 text = ~paste0("<b>Municipality:</b> ", Inicio,"<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(total_total)," Million","<br><b>Portion Municipalities:</b> ",funcao_percentual_taxa(total_total/sum(total_total)),"<br><b>Position Municipality:</b> ",order(total_total, decreasing = TRUE),"° Place" ),             
  ...
  hoverinfo = "text"
      ...
      layout(showlegend=TRUE ,
             ...
             yaxis = list(side = 'left',zeroline = FALSE,showlegend = FALSE ,title = '<b>Guaranteed Debt - R$ Million</b> ', showline = FALSE ,showgrid = FALSE, zeroline = TRUE,tickformat = ",.2r"
...
> **Source:**  [Brazilian National Treasury Secretary](https://www.gov.br/tesouronacional/en/federal-public-debt)
<br>**Note:**  `r nrow(agrupador_formatado_municipios)` 
municipalities have debt guaranteed by the Federal Government.
However, `r nrow(agrupador_formatado_municipios)-max(rank(-agrupador_ATM_municipios_formatado$ATM_Total))` municipalities have not yet made any disbursements and, therefore, their balance of guaranteed debt is zero.
...
output$ATM_municipios <-renderPlotly(
  ...
  plot_ly(agrupador_ATM_municipios_formatado, x=~Inicio) %>%
       ...
       add_trace(y = ~ATM_Total,
                 ...
                 text = ~paste0("<b>Municipality:</b> ", Inicio,"<br><b>ATM:</b> ",round(ATM_Total,2)," years"),
                hoverinfo = "text"
    ...
    add_trace(y = ~sum((agrupador_ATM_municipios_formatado$ATM_Total*agrupador_formatado_municipios$total_total))/sum(agrupador_formatado_municipios$total_total) ,
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_ATM_municipios_formatado$ATM_Total*agrupador_formatado_municipios$total_total))/sum(agrupador_formatado_municipios$total_total),2)," years"),
      ...
      layout(showlegend=TRUE, 
             ...
             yaxis = list(side = 'left',showlegend = FALSE,showgrid = FALSE ,title = '<b>ATM (anos)</b> ', showline = FALSE , zeroline = FALSE,hoverformat = '.2f'
...
> **Source:**  [Brazilian National Treasury Secretary](https://www.gov.br/tesouronacional/en/federal-public-debt)
<br>**Note:** `r nrow(agrupador_formatado_municipios)-max(rank(-agrupador_ATM_municipios_formatado$ATM_Total))` municipalities have not yet made any disbursements and, therefore, their respective ATM's are equal to zero.
...
output$custos_municipios <-renderPlotly(
  ...
  plot_ly(agrupador_custo_municipios_formatado, x=~Inicio) %>%
       ...
       add_trace(y = ~Custo_total_formatado,
                 ...
                 text = ~paste0("<b>Municipality:</b> ", Inicio,"<br><b>Average Cost:</b> ",round(Custo_total_formatado,2),"% p.a"),              
  ...
  hoverinfo = "text"
    ...
    add_trace(y = ~sum((agrupador_custo_municipios_formatado$Custo_total_formatado*agrupador_formatado_municipios$total_total))/sum(agrupador_formatado_municipios$total_total) ,
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_custo_municipios_formatado$Custo_total_formatado*agrupador_formatado_municipios$total_total))/sum(agrupador_formatado_municipios$total_total),2),"% p.a" ),
...
> **Source:**  [Brazilian National Treasury Secretary](https://www.gov.br/tesouronacional/en/federal-public-debt)
<br>**Note:** `r nrow(agrupador_formatado_municipios)-max(rank(-agrupador_ATM_municipios_formatado$ATM_Total))` municipalities have not yet made any disbursements and, therefore, their respective costs are equal to zero. 
...
output$cambial_municipios <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_municipios, x=~Inicio) %>%
       ...
       add_trace(y = ~100*((total_cambial)/(total_total)),
                 ...
                 text = ~paste0("<b>Municipality:</b> ", Inicio,"<br><b>Fx-Linked:</b> ",round(100*(total_cambial/total_total),2),"%"),              
...
observeEvent(Garantia_ATM_reativo_bancos_federais(),{
  ...
  output$Garantia_ATM_bancos_federais <- renderText(paste0(str_replace_all(round(filtro_classificador_estado_atm_bancos_federais$ATM_Total,2),"\\.",","), " years"))
  ...
  output$Garantia_custo_bancos_federais <- renderText(paste0(filtro_classificador_custo_bancos_federais$Custo_Total, " p.a"))
...
output$divida_total_bancos_federais <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_bancos_federais, x=~Inicio) %>%
       ...
       add_trace(y = ~total_total/1000000,
                 ...
                 text = ~paste0("<b>Federal Bank:</b> ", Inicio,"<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(total_total)," Milhões","<br><b>Portion Federal Banks:</b> ",funcao_percentual_taxa(total_total/sum(total_total)) ,"<br><b>Position Federal Bank:</b> ",order(total_total, decreasing = TRUE),"° Place" ),   
...
output$ATM_bancos_federais <-renderPlotly(
  ...
  plot_ly(agrupador_ATM_bancos_federais_formatado, x=~Inicio) %>%
       ...
       add_trace(y = ~ATM_Total,
                 ...
                 text = ~paste0("<b>Federal Bank:</b> ", Inicio,"<br><b>ATM:</b> ",round(ATM_Total,2)," anos"),
                hoverinfo = "text"
  ...
  add_trace(y = ~sum((agrupador_ATM_bancos_federais_formatado$ATM_Total*agrupador_formatado_bancos_federais$total_total))/sum(agrupador_formatado_bancos_federais$total_total),
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_ATM_bancos_federais_formatado$ATM_Total*agrupador_formatado_bancos_federais$total_total))/sum(agrupador_formatado_bancos_federais$total_total),2)," years"),
...
output$custos_bancos_federais <-renderPlotly(
  ...
  plot_ly(agrupador_custo_bancos_federais_formatado, x=~Inicio) %>%
    ...
    add_trace(y = ~sum((agrupador_custo_bancos_federais_formatado$Custo_total_formatado*agrupador_formatado_bancos_federais$total_total))/sum(agrupador_formatado_bancos_federais$total_total) ,
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_custo_bancos_federais_formatado$Custo_total_formatado*agrupador_formatado_bancos_federais$total_total))/sum(agrupador_formatado_bancos_federais$total_total),2),"% p.a" ),
      ...
      hoverinfo = "text") %>%
       ...
       add_trace(y = ~Custo_total_formatado,
                 ...
                 text = ~paste0("<b>Federal Bank:</b> ", Inicio,"<br><b>Average Cost:</b> ",round(Custo_total_formatado,2),"% p.a"),              
...
output$cambial_bancos_federais <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_bancos_federais, x=~Inicio) %>%
       ...
       add_trace(y = ~100*((total_cambial)/(total_total)),
                 ...
                 text = ~paste0("<b>Federal Bank:</b> ", Inicio,"<br><b>Fx-Linked:</b> ",round(100*(total_cambial/total_total),2),"%"),              
  ...
  hoverinfo = "text"
      ...
      layout(legend = list(orientation = 'h', x = 0.8, y = 1.2,
             ...
             yaxis = list(side = 'left',showlegend = FALSE ,title = '<b>FX-Linekd part. Guaranteed Debt (%)</b> ', showline = FALSE ,showgrid = FALSE, zeroline = FALSE,hoverformat = '.2f', range =c(0,100)
...
fluidPage(
 fluidRow(
  ...
  column(width=6,align="center",div(style = "height:17px;color: #737373;background-color: ;","FX-Linekd:")),
...
observeEvent(Garantia_ATM_reativo_estatais_federais(),{
  ...
  output$Garantia_ATM_estatais_federais <- renderText(paste0(str_replace_all(round(filtro_classificador_estado_atm_estatais_federais$ATM_Total,2),"\\.",","), " years"))
  ...
  output$Garantia_custo_estatais_federais <- renderText(paste0(filtro_classificador_custo_estatais_federais$Custo_Total, " p.a"))
...
output$divida_total_estatais_federais <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_estatais_federais, x=~Inicio) %>%
       ...
       add_trace(y = ~total_total/1000000,
                 ...
                 text = ~paste0("<b>Federal SOE:</b> ", Inicio,"<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(total_total)," Million","<br><b>Portion Federal SOE:</b> ",funcao_percentual_taxa(total_total/sum(total_total)) ,"<br><b>Position Federal SOE:</b> ",order(total_total, decreasing = TRUE),"° Place" ),   
...
output$ATM_estatais_federais <-renderPlotly(
  ...
  plot_ly(agrupador_ATM_estatais_federais_formatado, x=~Inicio) %>%
       ...
       add_trace(y = ~ATM_Total,
                 ...
                 text = ~paste0("<b>Federal SOE:</b> ", Inicio,"<br><b>ATM:</b> ",round(ATM_Total,2)," years"),
                hoverinfo = "text"
  ...
  add_trace(y = ~sum((agrupador_ATM_estatais_federais_formatado$ATM_Total*agrupador_formatado_estatais_federais$total_total))/sum(agrupador_formatado_estatais_federais$total_total),
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_ATM_estatais_federais_formatado$ATM_Total*agrupador_formatado_estatais_federais$total_total))/sum(agrupador_formatado_estatais_federais$total_total),2)," years"),
...
output$custos_estatais_federais <-renderPlotly(
  ...
  plot_ly(agrupador_custo_estatais_federais_formatado, x=~Inicio) %>%
    ...
    add_trace(y = ~sum((agrupador_custo_estatais_federais_formatado$Custo_total_formatado*agrupador_formatado_estatais_federais$total_total))/sum(agrupador_formatado_estatais_federais$total_total) ,
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_custo_estatais_federais_formatado$Custo_total_formatado*agrupador_formatado_estatais_federais$total_total))/sum(agrupador_formatado_estatais_federais$total_total),2),"% p.a" ),
      ...
      hoverinfo = "text") %>%
       ...
       add_trace(y = ~Custo_total_formatado,
                 ...
                 text = ~paste0("<b>Federal SOE:</b> ", Inicio,"<br><b>Cost:</b> ",round(Custo_total_formatado,2),"% p.a"),              
...
output$cambial_estatais_federais <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_estatais_federais, x=~Inicio) %>%
       ...
       add_trace(y = ~100*((total_cambial)/(total_total)),
                 ...
                 text = ~paste0("<b>Federal SOE:</b> ", Inicio,"<br><b>FX-Linked:</b> ",round(100*(total_cambial/total_total),2),"%"),              
  ...
  hoverinfo = "text"
      ...
      layout(legend = list(orientation = 'h', x = 0.8, y = 1.2,
             ...
             yaxis = list(side = 'left',showlegend = FALSE ,title = '<b>FX-Linked part. Guaranteed Debt (%)</b> ', showline = FALSE ,showgrid = FALSE, zeroline = FALSE,hoverformat = '.2f', range =c(0,100)
...
observeEvent(Garantia_ATM_reativo_entidades_estaduais(),{
  ...
  output$Garantia_ATM_entidades_estaduais <- renderText(paste0(str_replace_all(round(filtro_classificador_estado_atm_entidades_estaduais$ATM_Total,2),"\\.",","), " years"))
  ...
  output$Garantia_custo_entidades_estaduais <- renderText(paste0(filtro_classificador_custo_entidades_estaduais$Custo_Total, " p.a"))
...
output$divida_total_entidades_estaduais <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_entidades_estaduais, x=~Inicio) %>%
       ...
       add_trace(y = ~total_total/1000000,
                 ...
                 text = ~paste0("<b>Controlled Entities:</b> ", Inicio,"<br><b>Guaranteed Debt:</b> ","R$",funcao_formata_quantidade_2(total_total)," Million","<br><b>Portion Controlled Entities:</b> ",funcao_percentual_taxa(total_total/sum(total_total)) ,"<br><b>Position Controlled Entities:</b> ",order(total_total, decreasing = TRUE),"° Place" ),   
...
output$ATM_entidades_estaduais <-renderPlotly(
  ...
  plot_ly(agrupador_ATM_entidades_estaduais_formatado, x=~Inicio) %>%
       ...
       add_trace(y = ~ATM_Total,
                 ...
                 text = ~paste0("<b>Controlled Entities:</b> ", Inicio,"<br><b>ATM:</b> ",round(ATM_Total,2)," years"),
                hoverinfo = "text"
  ...
  add_trace(y = ~sum((agrupador_ATM_entidades_estaduais_formatado$ATM_Total*agrupador_formatado_entidades_estaduais$total_total))/sum(agrupador_formatado_entidades_estaduais$total_total),
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_ATM_entidades_estaduais_formatado$ATM_Total*agrupador_formatado_entidades_estaduais$total_total))/sum(agrupador_formatado_entidades_estaduais$total_total),2)," years"),
...
output$custos_entidades_estaduais <-renderPlotly(
  ...
  plot_ly(agrupador_custo_entidades_estaduais_formatado, x=~Inicio) %>%
    ...
    add_trace(y = ~sum((agrupador_custo_entidades_estaduais_formatado$Custo_total_formatado*agrupador_formatado_entidades_estaduais$total_total))/sum(agrupador_formatado_entidades_estaduais$total_total) ,
              ...
              showlegend =TRUE,
              name ="Average",
      text = ~paste0("<b>Average:</b> ",round(sum((agrupador_custo_entidades_estaduais_formatado$Custo_total_formatado*agrupador_formatado_entidades_estaduais$total_total))/sum(agrupador_formatado_entidades_estaduais$total_total),2),"% p.a" ),
      ...
      hoverinfo = "text") %>%
       ...
       add_trace(y = ~Custo_total_formatado,
                 ...
                 text = ~paste0("<b>Controlled Entities:</b> ", Inicio,"<br><b>Average Cost:</b> ",round(Custo_total_formatado,2),"% p.a"),              
...
output$cambial_entidades_estaduais <-renderPlotly(
  ...
  plot_ly(agrupador_formatado_entidades_estaduais, x=~Inicio) %>%
       ...
       add_trace(y = ~100*((total_cambial)/(total_total)),
                 ...
                 text = ~paste0("<b>Controlled Entities:</b> ", Inicio,"<br><b>FX-Linked:</b> ",round(100*(total_cambial/total_total),2),"%"),              
...
fluidRow(
  column(2, selectInput("Ano",
                  label="Year",width = '20px',
                  choices = unique(c("All",sort(novos_contratos_2010$Ano, decreasing = TRUE))),
...
selectInput("Grupo", 
                 ...
                 choices = unique(c("All",sort(novos_contratos_2010$Tipo_Mutuario, decreasing = TRUE))),
                 selected = "All"
)),
...
selectInput("Entidade", 
              ...
              choices = unique(c("All",sort(novos_contratos_2010$Mutuario, decreasing = TRUE))),
                     selected = "a"
...
selectInput("Status", 
                     label="Status",
                     choices = unique(c("All",sort(novos_contratos_2010$Status, decreasing = TRUE))),
                     selected = "All"
            )),
...
column(2,
selectInput("Tipo",label="Type of Debt",
                     choices = unique(c("All",sort(novos_contratos_2010$Tipo))),
                selected = "All"))
...
output$Contratos <- renderDT({

  datatable(filtro_tipo_contratos_assinados[,c(28,1,17,30,3,5,29,9,10,22,23)], 
          rownames = FALSE,
    ...
    "}"),
     ...
     colnames = c('YEAR','CONTRACT' ,'SIGNING DATE', 'TYPE OF ENTITY', 'DEBTOR','FU' ,'STATUS', 'TYPE OF DEBT', 'CREDITOR', 'CURRENCY', 'CONTRACTED AMOUNT')
...
observe({
      ...
      updateSelectInput(session, "Entidade",
                        choices = unique(c("All",filtro_grupo_contratos_assinados$Mutuario)),
                        selected = paste("a")
